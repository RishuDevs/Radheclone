...
from RadheMusic.utils import AdminRightsCheck
from RadheMusic.utils.database import is_active_chat, is_nonadmin_chat
from RadheMusic.utils.decorators.language import languageCB
from RadheMusic.utils.inline import close_markup, speed_markup
...
async def del_back_playlist(client, callback_query, _):
    ...
    try:
        await RadheMusic.speedup_stream(
            chat_id,
            file_path,
            speed,
            playing,
