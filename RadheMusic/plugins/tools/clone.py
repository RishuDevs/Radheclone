...
from RadheMusic.utils.database import get_assistant, clonebotdb
from RadheMusic.utils.database.clonedb import has_user_cloned_any_bot
    ...
    if len(message.command) > 1:
        ...
        try:
            ai = Client(
                ...
                API_HASH,
                bot_token=bot_token,
                plugins=dict(root="RadheMusic.cplugin"), 
            )
            await ai.start()
            bot = await ai.get_me()
